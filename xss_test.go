...
func TemplateAutoEscape(writer http.ResponseWriter, request *http.Request) {
	myTemplates.ExecuteTemplate(writer, "post.go.html", map[string]any{
		"Title": "Template Auto Escape",
		"Body":  "<h1>Ini Adalah Body<script>alert('Anda di hack')</script></h1>",
	})
}
...
func TemplateAutoEscapeDisabled(writer http.ResponseWriter, request *http.Request) {
	myTemplates.ExecuteTemplate(writer, "post.go.html", map[string]any{
		"Title": "Template Auto Escape",
		"Body":  template.HTML("<p>Ini Adalah Body<p>alert('Anda di hack')</script></p>"),
	})
}
